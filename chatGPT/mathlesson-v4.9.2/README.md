...
Current packaged build: `mathlesson.v4.9.2.html`.
...
```text
mathlesson-v4.9.2-current-package/
  README.md
  START_HERE.md
  ...
  MovingAngle-1.mp4
  checklists/
    mathlesson-v4.9.2-master-test-checklist.md
  ...
  lesson-packs/
    ...
    stress-test-v2.0/
  prompts/
    prompt-for-JSON-lesson-v1.4.txt
    earlier prompt versions...
  reference-lessons/
  roadmap/
    mathlesson-roadmap-v4.9.2-authoring-workspace-correction-pass.md
...
3. Open `mathlesson.v4.9.2.html` in a browser.
...
`checklists/mathlesson-v4.9.2-master-test-checklist.md`
